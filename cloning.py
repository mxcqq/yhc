...
class YC:
    def __init__(self, email, pw):
        ...
        try:
            ...
            print ("\033[31m[\033[32m!\033[31m] \033[39mLogin Success ✔ ")
            print ("\033[36m" + 50*"-")
            print ("\033[36m|" + 11*" " + "\033[35mEmail" + 11*" " + "\033[36m|" + 8*" " + "\033[33mVuln" + 8*" " + "\033[36m|")
            print ("\033[36m" + 50*"-")
        except KeyError:
            print ("\033[31m[\033[39m-\033[31m] \033[39mʟᴏɢɪɴ ꜰᴀɪʟᴇᴅ ! ")
            sys.exit()
...
YC(str(input("\033[31m[\033[39m+\033[31m] \033[39mᴇᴍᴀɪʟ : ")), str(input("\033[31m[\033[39m+\033[31m] \033[39mᴘᴀꜱꜱᴡᴏʀᴅ : ")))
